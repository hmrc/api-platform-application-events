...
import uk.gov.hmrc.apiplatform.modules.applications.core.domain.models.{CollaboratorFixtures, CoreApplicationFixtures, LoginRedirectUri}
...
trait EventTestData extends CoreApplicationFixtures with CollaboratorFixtures with ApiIdentifierFixtures with ActorFixtures with FixedClock {
  ...
  val aRedirectUri: LoginRedirectUri        = LoginRedirectUri.unsafeApply("http://localhost:8000/some")
  val toChangeRedirectUri: LoginRedirectUri = LoginRedirectUri.unsafeApply("http://localhost:8000/different")
