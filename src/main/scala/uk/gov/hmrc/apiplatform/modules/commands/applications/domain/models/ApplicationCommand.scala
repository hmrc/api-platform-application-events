...
import uk.gov.hmrc.apiplatform.modules.events.applications.domain.models.{Collaborator, _}
...
case class AddCollaborator(actor: Actor,  collaborator: Collaborator, adminsToEmail:Set[String], timestamp: Instant) extends ApplicationCommand
case class RemoveCollaborator(actor: Actor,  collaborator: Collaborator, adminsToEmail:Set[String], timestamp: Instant) extends ApplicationCommand
...
case class ChangeResponsibleIndividualToSelf(instigator: UserId, timestamp: Instant, name: String, email: String) extends ApplicationCommand
case class ChangeResponsibleIndividualToOther(code: String, timestamp: Instant) extends ApplicationCommand
case class VerifyResponsibleIndividual(instigator: UserId, timestamp: Instant, requesterName: String, riName: String, riEmail: String) extends ApplicationCommand
...
case class DeleteApplicationByGatekeeper(gatekeeperUser: String, requestedByEmailAddress: String, reasons: String, timestamp: Instant) extends GatekeeperSpecificApplicationCommand
